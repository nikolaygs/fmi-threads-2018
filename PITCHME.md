...
NB! Ключовата дума volatile осигурява атомарност само и единствено на простите операции върху примитиви. 
```
...
@ul
- избягване на притежаване на повече монитори 
...
Нишка може да заяви, че иска да изчака, докато като дадено събитие се случи в друга нишка чрез метода wait() на java.lang.Object
...
Всички имплементации имат методи get() и set() за достъп до съхраняваната променлива. Tе са еквивалентни на четене и модификация на volatile променлива. В допълнение Предоставя методи, емулиращи атомарни операции, които не използват синхронизация
