...
Стандартни (non-daemon) нишки – те изпълняват задачи, които са свързани с основната идея на програмата. Всяка JVM работи, докато има поне една стандартна нишка, която още не е приключила с изпълнение на своята задача

@fa[arrow-down]
+++

 Демонови (daemon) нишки – те изпълняват задачи, които не са част от логиката на програмата, а по-скоро се класифицират като общи услуги. JVM ще прекрати работата на нишките от този тип, без значение от състоянието в което се намират, ако няма поне една работеща стандартна нишка
