...
В синхронизираната секция, нямаме възможност за конкурентно изпълнение, така, че ако критичната ни секция е ненужно голяма, това може да доведе до сериозни проблеми с бързодействието
